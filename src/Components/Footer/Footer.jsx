...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {serviceFeatures.map((feature, index) => (
              <div key={index} className="group">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-2xl hover:from-gray-700 hover:to-gray-800 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border border-gray-700/50">
      ...
      {/* Newsletter Section */}
      <div className="relative z-10 bg-gradient-to-r from-gray-800/80 to-gray-900/80 border-b border-gray-700/50">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Subscribe to get exclusive deals, new arrivals, and home décor inspiration
            </p>
          </div>
            ...
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur text-white rounded-xl border border-gray-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent placeholder-gray-400"
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
              ...
              <button
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Subscribe
              </button>
            </div>
            {isSubscribed && (
              <div className="flex items-center justify-center gap-2 text-green-400 text-sm mt-3 animate-pulse">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mt-6 pt-6 border-t border-gray-600/30">
            <p className="text-sm text-gray-400">
              Developed with <Heart size={14} className="inline text-red-500 fill-current mx-1" /> by 
